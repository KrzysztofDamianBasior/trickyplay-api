...
* Used JUnit as the testing framework, Mockito for mocking, AssertJ for creating assertions and Testcontainers for integration tests
...
* Define the following secrets:
  ...
  * db-root -database root password
