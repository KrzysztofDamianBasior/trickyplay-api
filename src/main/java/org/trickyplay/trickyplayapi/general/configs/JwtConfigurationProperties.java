...
// It is standard practice to throw an exception during application startup if required
// environment variables haven't been provided or if they don't meet certain validation rules
@Validated
